...
<li>🔭 Possuo afinidade com desenvolvimento front-end (HTML/CSS/JS) e análise de dados (Python/Databricks)</li>

<li>📚 Também possuo experiência desenvolvimento mobile e back-end (Java)</li>
